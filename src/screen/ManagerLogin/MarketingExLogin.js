...
import Marketing_Executive_Expense from '../Marketing_Executive_Expense';
import MarketingHeadExpense from '../MarketingHeadExpense';
  ...
  return (
    <SafeAreaView className=" flex-1" style={{backgroundColor: '#4e2d87'}}>
      <View className={`flex-1 `}>
        ...
        <View className='px-5'>
          <View className={`w-[100%] h-[83%] bg-white rounded-lg shadow-lg px-5 py-5`}>
            <View className='space-y-3'>
              ...
              <TouchableOpacity 
              onPress={() => navigation.navigate('MarketingButton')} // Move onPress to TouchableOpacity
              className='items-center justify-center bg-amber-500 rounded-lg py-2.5 w-[100%]'>
...
export default MarketingExLogin;

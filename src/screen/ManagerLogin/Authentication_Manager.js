...
const Authentication_Manager = () => {
  ...
  return (
      ...
      <View className={`flex-1 `}>
        ...
        <View>
        <Text className='text-white text-lg font-medium p-2 ml-5 mb--11 '>Sign in to Continue</Text>
        </View>
          ...
          <View className={`w-[100%] h-[83%] bg-white rounded-lg shadow-lg px-5 py-5`}>
            <View className='space-y-3'>
              ...
              <View className='items-center justify-center'>
                <TouchableOpacity onPress={() => navigation.navigate('Setcredit')} className='bg-amber-500  rounded-lg py-2.5 w-[100%]'>
...
export default Authentication_Manager;

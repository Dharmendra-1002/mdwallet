      ...
      <View className={`flex-1 justify-center items-center `}>
        <View className={`w-11/12 h-5/6 bg-white rounded-lg shadow-lg p-4`}>
          <View className={`flex justify-center items-center `}>
            <View className={`w-11/12 h-52 m-10 rounded-lg shadow-lg p-4`} style={{backgroundColor: '#4e2d87'}}>
          ...
          <View className='flex-row justify-evenly'>
            <TouchableOpacity onPress={() =>navigation.navigate('Statement')}>
              <View className='w-[140] py-5 items-center rounded-lg' style={{backgroundColor: '#4e2d87'}}>
